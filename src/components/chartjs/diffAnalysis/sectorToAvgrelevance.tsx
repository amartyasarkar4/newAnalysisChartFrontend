    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://newsanalysischartbackend-1.onrender.com/api/v1/amartya/sector_to_avgRelevanceAndIntensity"
        );
        if (!response.ok) {
...
export default SectorToAvgrelevance;
